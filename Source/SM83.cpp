...
void SM83::executeInstruction() {
    ...
    // 0x01  LD BC,nn
    case 0x01:
        LD_n_nn(Registers.BC);
        break;
    // 0x11  LD DE,nn
    case 0x11:
        LD_n_nn(Registers.DE);
        break;
    // 0x21  LD HL,nn
    case 0x21:
        LD_n_nn(Registers.HL);
        break;
    // 0x31  LD SP,nn
    case 0x31:
        LD_n_nn(Registers.SP);
        break;
    ...
    // 0x20  JR NZ,n
    case 0x20:
        cycleCount = JR_cc_n(0);
        break;
    // 0x28  JR Z,n
    case 0x28:
        cycleCount = JR_cc_n(1);
        break;
    // 0x30  JR NC,n
    case 0x30:
        cycleCount = JR_cc_n(2);
        break;
    // 0x38  JR C,n
    case 0x38:
        cycleCount = JR_cc_n(3);
        break;
    ...
    case 0x45:
        ...
        break;
    case 0x46:
        Registers.B = mmu->readByte(Registers.HL);
        break;
    case 0x47:
    ...
    case 0x4D:
        ...
        break;
    case 0x4E:
        Registers.C = mmu->readByte(Registers.HL);
        break;
    case 0x4F:
    ...
    case 0x55:
        ...
        break;
    case 0x56:
        Registers.D = mmu->readByte(Registers.HL);
        break;
    case 0x57:
    ...
    case 0x5D:
        ...
        break;
    case 0x5E:
        Registers.E = mmu->readByte(Registers.HL);
        break;
    case 0x5F:
    ...
    case 0x65:
        ...
        break;
    case 0x66:
        Registers.H = mmu->readByte(Registers.HL);
        break;
    case 0x67:
    ...
    case 0x6D:
        ...
        break;
    case 0x6E:
        Registers.L = mmu->readByte(Registers.HL);
        break;
    case 0x6F:
    ...
    // Row 0x70 ? LD (HL),x
    case 0x70:
        mmu->writeByte(Registers.HL, Registers.B);
        break;
    case 0x71:
        mmu->writeByte(Registers.HL, Registers.C);
        break;
    case 0x72:
        mmu->writeByte(Registers.HL, Registers.D);
        break;
    case 0x73:
        mmu->writeByte(Registers.HL, Registers.E);
        break;
    case 0x74:
        mmu->writeByte(Registers.HL, Registers.H);
        break;
    case 0x75:
        mmu->writeByte(Registers.HL, Registers.L);
        break;
    ...
    case 0x85:
        ...
        break;
    case 0x86:
        ADD_A_n(mmu->readByte(Registers.HL));
        break;
    case 0x87:
        ADD_A_n(Registers.A);
        break;
    ...
    case 0x8D:
        ...
        break;
    case 0x8E:
        ADC_A_n(mmu->readByte(Registers.HL));
        break;
    case 0x8F:
        ADC_A_n(Registers.A);
        break;
    ...
    case 0x95:
        ...
        break;
    case 0x96:
        SUB_A_n(mmu->readByte(Registers.HL));
        break;
    case 0x97:
        SUB_A_n(Registers.A);
        break;
    ...
    case 0x9D:
        ...
        break;
    case 0x9E:
        SBC_A_n(mmu->readByte(Registers.HL));
        break;
    case 0x9F:
        SBC_A_n(Registers.A);
        break;
    ...
    case 0xA5:
        ...
        break;
    case 0xA6:
        AND_A_n(mmu->readByte(Registers.HL));
        break;
    case 0xA7:
        AND_A_n(Registers.A);
        break;
    ...
    case 0xAD:
        ...
        break;
    case 0xAE:
        XOR_A_n(mmu->readByte(Registers.HL));
        break;
    case 0xAF:
        XOR_A_n(Registers.A);
        break;
    ...
    case 0xB5:
        ...
        break;
    case 0xB6:
        OR_A_n(mmu->readByte(Registers.HL));
        break;
    case 0xB7:
        OR_A_n(Registers.A);
        break;
    ...
    case 0xBD:
        ...
        break;
    case 0xBE:
        CP_A_n(mmu->readByte(Registers.HL));
        break;
    case 0xBF:
        CP_A_n(Registers.A);
        break;
    ...
    // 0xD2  JP NC,nn
    case 0xD2:
        cycleCount = JP_cc_nn(2);
        break;
    // 0xD3  ILLEGAL
    // 0xD4  CALL NC,nn
    case 0xD4:
        cycleCount = CALL_cc_nn(2);
        break;
    // 0xD5  PUSH DE
    case 0xD5:
    ...
    // 0xDA  JP C,nn
    case 0xDA:
        cycleCount = JP_cc_nn(3);
        break;
    // 0xDB  ILLEGAL
    // 0xDC  CALL C,nn
    case 0xDC:
        cycleCount = CALL_cc_nn(3);
        break;
    // 0xDD  ILLEGAL
    // 0xDE  SBC A,n
    case 0xDE:
...
void SM83::executePrefixedInstruction() {
    ...
    case 0x05:
        ...
        break;
    case 0x06: {
        uint8_t v = mmu->readByte(Registers.HL);
        RLC_n(v);
        mmu->writeByte(Registers.HL, v);
        break;
    }
    case 0x07:
        RLC_n(Registers.A);
    ...
    case 0x40:
        BIT_b_r(0, Registers.B);
        break;
    case 0x41:
        BIT_b_r(0, Registers.C);
        break;
    case 0x42:
        BIT_b_r(0, Registers.D);
        break;
    case 0x43:
        BIT_b_r(0, Registers.E);
        break;
    case 0x44:
        BIT_b_r(0, Registers.H);
        break;
    case 0x45:
        BIT_b_r(0, Registers.L);
        break;
    case 0x46:
        BIT_b_r(0, mmu->readByte(Registers.HL));
        break;
    case 0x47:
        BIT_b_r(0, Registers.A);
        break;
    // 0xCB 0x48-0x4F  BIT 1,r
    case 0x48:
        BIT_b_r(1, Registers.B);
        break;
    case 0x49:
        BIT_b_r(1, Registers.C);
        break;
    case 0x4A:
        BIT_b_r(1, Registers.D);
        break;
    case 0x4B:
        BIT_b_r(1, Registers.E);
        break;
    case 0x4C:
        BIT_b_r(1, Registers.H);
        break;
    case 0x4D:
        BIT_b_r(1, Registers.L);
        break;
    case 0x4E:
        BIT_b_r(1, mmu->readByte(Registers.HL));
        break;
    case 0x4F:
        BIT_b_r(1, Registers.A);
        break;
    // 0xCB 0x50-0x57  BIT 2,r
    case 0x50:
        BIT_b_r(2, Registers.B);
        break;
    case 0x51:
        BIT_b_r(2, Registers.C);
        break;
    case 0x52:
        BIT_b_r(2, Registers.D);
        break;
    case 0x53:
        BIT_b_r(2, Registers.E);
        break;
    case 0x54:
        BIT_b_r(2, Registers.H);
        break;
    case 0x55:
        BIT_b_r(2, Registers.L);
        break;
    case 0x56:
        BIT_b_r(2, mmu->readByte(Registers.HL));
        break;
    case 0x57:
        BIT_b_r(2, Registers.A);
        break;
    // 0xCB 0x58-0x5F  BIT 3,r
    case 0x58:
        BIT_b_r(3, Registers.B);
        break;
    case 0x59:
        BIT_b_r(3, Registers.C);
        break;
    case 0x5A:
        BIT_b_r(3, Registers.D);
        break;
    case 0x5B:
        BIT_b_r(3, Registers.E);
        break;
    case 0x5C:
        BIT_b_r(3, Registers.H);
        break;
    case 0x5D:
        BIT_b_r(3, Registers.L);
        break;
    case 0x5E:
        BIT_b_r(3, mmu->readByte(Registers.HL));
        break;
    case 0x5F:
        BIT_b_r(3, Registers.A);
        break;
    // 0xCB 0x60-0x67  BIT 4,r
    case 0x60:
        BIT_b_r(4, Registers.B);
        break;
    case 0x61:
        BIT_b_r(4, Registers.C);
        break;
    case 0x62:
        BIT_b_r(4, Registers.D);
        break;
    case 0x63:
        BIT_b_r(4, Registers.E);
        break;
    case 0x64:
        BIT_b_r(4, Registers.H);
        break;
    case 0x65:
        BIT_b_r(4, Registers.L);
        break;
    case 0x66:
        BIT_b_r(4, mmu->readByte(Registers.HL));
        break;
    case 0x67:
        BIT_b_r(4, Registers.A);
        break;
    // 0xCB 0x68-0x6F  BIT 5,r
    case 0x68:
        BIT_b_r(5, Registers.B);
        break;
    case 0x69:
        BIT_b_r(5, Registers.C);
        break;
    case 0x6A:
        BIT_b_r(5, Registers.D);
        break;
    case 0x6B:
        BIT_b_r(5, Registers.E);
        break;
    case 0x6C:
        BIT_b_r(5, Registers.H);
        break;
    case 0x6D:
        BIT_b_r(5, Registers.L);
        break;
    case 0x6E:
        BIT_b_r(5, mmu->readByte(Registers.HL));
        break;
    case 0x6F:
        BIT_b_r(5, Registers.A);
        break;
    // 0xCB 0x70-0x77  BIT 6,r
    case 0x70:
        BIT_b_r(6, Registers.B);
        break;
    case 0x71:
        BIT_b_r(6, Registers.C);
        break;
    case 0x72:
        BIT_b_r(6, Registers.D);
        break;
    case 0x73:
        BIT_b_r(6, Registers.E);
        break;
    case 0x74:
        BIT_b_r(6, Registers.H);
        break;
    case 0x75:
        BIT_b_r(6, Registers.L);
        break;
    case 0x76:
        BIT_b_r(6, mmu->readByte(Registers.HL));
        break;
    case 0x77:
        BIT_b_r(6, Registers.A);
        break;
    // 0xCB 0x78-0x7F  BIT 7,r
    case 0x78:
        BIT_b_r(7, Registers.B);
        break;
    case 0x79:
        BIT_b_r(7, Registers.C);
        break;
    case 0x7A:
        BIT_b_r(7, Registers.D);
        break;
    case 0x7B:
        BIT_b_r(7, Registers.E);
        break;
    case 0x7C:
        BIT_b_r(7, Registers.H);
        break;
    case 0x7D:
        BIT_b_r(7, Registers.L);
        break;
    case 0x7E:
        BIT_b_r(7, mmu->readByte(Registers.HL));
        break;
    case 0x7F:
        BIT_b_r(7, Registers.A);
        break;

    // -------------------------------------------------------------------------
    // 0xCB 0x80-0x87  RES 0,r
    case 0x80:
        RES_b_r(0, Registers.B);
        break;
    case 0x81:
        RES_b_r(0, Registers.C);
        break;
    case 0x82:
        RES_b_r(0, Registers.D);
        break;
    case 0x83:
        RES_b_r(0, Registers.E);
        break;
    case 0x84:
        RES_b_r(0, Registers.H);
        break;
    case 0x85:
        RES_b_r(0, Registers.L);
        break;
    case 0x86: {
        uint8_t v = mmu->readByte(Registers.HL);
        RES_b_r(0, v);
    ...
    case 0x87:
        RES_b_r(0, Registers.A);
        break;
    // 0xCB 0x88-0x8F  RES 1,r
    case 0x88:
        RES_b_r(1, Registers.B);
        break;
    case 0x89:
        RES_b_r(1, Registers.C);
        break;
    case 0x8A:
        RES_b_r(1, Registers.D);
        break;
    case 0x8B:
        RES_b_r(1, Registers.E);
        break;
    case 0x8C:
        RES_b_r(1, Registers.H);
        break;
    case 0x8D:
        RES_b_r(1, Registers.L);
        break;
    case 0x8E: {
        uint8_t v = mmu->readByte(Registers.HL);
        RES_b_r(1, v);
    ...
    case 0x8F:
        RES_b_r(1, Registers.A);
        break;
    // 0xCB 0x90-0x97  RES 2,r
    case 0x90:
        RES_b_r(2, Registers.B);
        break;
    case 0x91:
        RES_b_r(2, Registers.C);
        break;
    case 0x92:
        RES_b_r(2, Registers.D);
        break;
    case 0x93:
        RES_b_r(2, Registers.E);
        break;
    case 0x94:
        RES_b_r(2, Registers.H);
        break;
    case 0x95:
        RES_b_r(2, Registers.L);
        break;
    case 0x96: {
        uint8_t v = mmu->readByte(Registers.HL);
        RES_b_r(2, v);
    ...
    case 0x97:
        RES_b_r(2, Registers.A);
        break;
    // 0xCB 0x98-0x9F  RES 3,r
    case 0x98:
        RES_b_r(3, Registers.B);
        break;
    case 0x99:
        RES_b_r(3, Registers.C);
        break;
    case 0x9A:
        RES_b_r(3, Registers.D);
        break;
    case 0x9B:
        RES_b_r(3, Registers.E);
        break;
    case 0x9C:
        RES_b_r(3, Registers.H);
        break;
    case 0x9D:
        RES_b_r(3, Registers.L);
        break;
    case 0x9E: {
        uint8_t v = mmu->readByte(Registers.HL);
        RES_b_r(3, v);
    ...
    case 0x9F:
        RES_b_r(3, Registers.A);
        break;
    // 0xCB 0xA0-0xA7  RES 4,r
    case 0xA0:
        RES_b_r(4, Registers.B);
        break;
    case 0xA1:
        RES_b_r(4, Registers.C);
        break;
    case 0xA2:
        RES_b_r(4, Registers.D);
        break;
    case 0xA3:
        RES_b_r(4, Registers.E);
        break;
    case 0xA4:
        RES_b_r(4, Registers.H);
        break;
    case 0xA5:
        RES_b_r(4, Registers.L);
        break;
    case 0xA6: {
        uint8_t v = mmu->readByte(Registers.HL);
        RES_b_r(4, v);
    ...
    case 0xA7:
        RES_b_r(4, Registers.A);
        break;
    // 0xCB 0xA8-0xAF  RES 5,r
    case 0xA8:
        RES_b_r(5, Registers.B);
        break;
    case 0xA9:
        RES_b_r(5, Registers.C);
        break;
    case 0xAA:
        RES_b_r(5, Registers.D);
        break;
    case 0xAB:
        RES_b_r(5, Registers.E);
        break;
    case 0xAC:
        RES_b_r(5, Registers.H);
        break;
    case 0xAD:
        RES_b_r(5, Registers.L);
        break;
    case 0xAE: {
        uint8_t v = mmu->readByte(Registers.HL);
        RES_b_r(5, v);
    ...
    case 0xAF:
        RES_b_r(5, Registers.A);
        break;
    // 0xCB 0xB0-0xB7  RES 6,r
    case 0xB0:
        RES_b_r(6, Registers.B);
        break;
    case 0xB1:
        RES_b_r(6, Registers.C);
        break;
    case 0xB2:
        RES_b_r(6, Registers.D);
        break;
    case 0xB3:
        RES_b_r(6, Registers.E);
        break;
    case 0xB4:
        RES_b_r(6, Registers.H);
        break;
    case 0xB5:
        RES_b_r(6, Registers.L);
        break;
    case 0xB6: {
        uint8_t v = mmu->readByte(Registers.HL);
        RES_b_r(6, v);
    ...
    case 0xB7:
        RES_b_r(6, Registers.A);
        break;
    // 0xCB 0xB8-0xBF  RES 7,r
    case 0xB8:
        RES_b_r(7, Registers.B);
        break;
    case 0xB9:
        RES_b_r(7, Registers.C);
        break;
    case 0xBA:
        RES_b_r(7, Registers.D);
        break;
    case 0xBB:
        RES_b_r(7, Registers.E);
        break;
    case 0xBC:
        RES_b_r(7, Registers.H);
        break;
    case 0xBD:
        RES_b_r(7, Registers.L);
        break;
    case 0xBE: {
        uint8_t v = mmu->readByte(Registers.HL);
        RES_b_r(7, v);
    ...
    case 0xBF:
        RES_b_r(7, Registers.A);
        break;

    // -------------------------------------------------------------------------
    // 0xCB 0xC0-0xC7  SET 0,r
    case 0xC0:
        SET_b_r(0, Registers.B);
        break;
    case 0xC1:
        SET_b_r(0, Registers.C);
        break;
    case 0xC2:
        SET_b_r(0, Registers.D);
        break;
    case 0xC3:
        SET_b_r(0, Registers.E);
        break;
    case 0xC4:
        SET_b_r(0, Registers.H);
        break;
    case 0xC5:
        SET_b_r(0, Registers.L);
        break;
    case 0xC6: {
        uint8_t v = mmu->readByte(Registers.HL);
        SET_b_r(0, v);
    ...
    case 0xC7:
        SET_b_r(0, Registers.A);
        break;
    // 0xCB 0xC8-0xCF  SET 1,r
    case 0xC8:
        SET_b_r(1, Registers.B);
        break;
    case 0xC9:
        SET_b_r(1, Registers.C);
        break;
    case 0xCA:
        SET_b_r(1, Registers.D);
        break;
    case 0xCB:
        SET_b_r(1, Registers.E);
        break;
    case 0xCC:
        SET_b_r(1, Registers.H);
        break;
    case 0xCD:
        SET_b_r(1, Registers.L);
        break;
    case 0xCE: {
        uint8_t v = mmu->readByte(Registers.HL);
        SET_b_r(1, v);
    ...
    case 0xCF:
        SET_b_r(1, Registers.A);
        break;
    // 0xCB 0xD0-0xD7  SET 2,r
    case 0xD0:
        SET_b_r(2, Registers.B);
        break;
    case 0xD1:
        SET_b_r(2, Registers.C);
        break;
    case 0xD2:
        SET_b_r(2, Registers.D);
        break;
    case 0xD3:
        SET_b_r(2, Registers.E);
        break;
    case 0xD4:
        SET_b_r(2, Registers.H);
        break;
    case 0xD5:
        SET_b_r(2, Registers.L);
        break;
    case 0xD6: {
        uint8_t v = mmu->readByte(Registers.HL);
        SET_b_r(2, v);
    ...
    case 0xD7:
        SET_b_r(2, Registers.A);
        break;
    // 0xCB 0xD8-0xDF  SET 3,r
    case 0xD8:
        SET_b_r(3, Registers.B);
        break;
    case 0xD9:
        SET_b_r(3, Registers.C);
        break;
    case 0xDA:
        SET_b_r(3, Registers.D);
        break;
    case 0xDB:
        SET_b_r(3, Registers.E);
        break;
    case 0xDC:
        SET_b_r(3, Registers.H);
        break;
    case 0xDD:
        SET_b_r(3, Registers.L);
        break;
    case 0xDE: {
        uint8_t v = mmu->readByte(Registers.HL);
        SET_b_r(3, v);
    ...
    case 0xDF:
        SET_b_r(3, Registers.A);
        break;
    // 0xCB 0xE0-0xE7  SET 4,r
    case 0xE0:
        SET_b_r(4, Registers.B);
        break;
    case 0xE1:
        SET_b_r(4, Registers.C);
        break;
    case 0xE2:
        SET_b_r(4, Registers.D);
        break;
    case 0xE3:
        SET_b_r(4, Registers.E);
        break;
    case 0xE4:
        SET_b_r(4, Registers.H);
        break;
    case 0xE5:
        SET_b_r(4, Registers.L);
        break;
    case 0xE6: {
        uint8_t v = mmu->readByte(Registers.HL);
        SET_b_r(4, v);
    ...
    case 0xE7:
        SET_b_r(4, Registers.A);
        break;
    // 0xCB 0xE8-0xEF  SET 5,r
    case 0xE8:
        SET_b_r(5, Registers.B);
        break;
    case 0xE9:
        SET_b_r(5, Registers.C);
        break;
    case 0xEA:
        SET_b_r(5, Registers.D);
        break;
    case 0xEB:
        SET_b_r(5, Registers.E);
        break;
    case 0xEC:
        SET_b_r(5, Registers.H);
        break;
    case 0xED:
        SET_b_r(5, Registers.L);
        break;
    case 0xEE: {
        uint8_t v = mmu->readByte(Registers.HL);
        SET_b_r(5, v);
    ...
    case 0xEF:
        SET_b_r(5, Registers.A);
        break;
    // 0xCB 0xF0-0xF7  SET 6,r
    case 0xF0:
        SET_b_r(6, Registers.B);
        break;
    case 0xF1:
        SET_b_r(6, Registers.C);
        break;
    case 0xF2:
        SET_b_r(6, Registers.D);
        break;
    case 0xF3:
        SET_b_r(6, Registers.E);
        break;
    case 0xF4:
        SET_b_r(6, Registers.H);
        break;
    case 0xF5:
        SET_b_r(6, Registers.L);
        break;
    case 0xF6: {
        uint8_t v = mmu->readByte(Registers.HL);
        SET_b_r(6, v);
    ...
    case 0xF7:
        SET_b_r(6, Registers.A);
        break;
    // 0xCB 0xF8-0xFF  SET 7,r
    case 0xF8:
        SET_b_r(7, Registers.B);
        break;
    case 0xF9:
        SET_b_r(7, Registers.C);
        break;
    case 0xFA:
        SET_b_r(7, Registers.D);
        break;
    case 0xFB:
        SET_b_r(7, Registers.E);
        break;
    case 0xFC:
        SET_b_r(7, Registers.H);
        break;
    case 0xFD:
        SET_b_r(7, Registers.L);
        break;
    case 0xFE: {
        uint8_t v = mmu->readByte(Registers.HL);
        SET_b_r(7, v);
...
int SM83::JP_cc_nn(int cc) {
    ...
    switch (cc) {
    case 0:
        taken = !Registers.checkFlag(Registers.ZERO_FLAG);
        break; // NZ
    case 1:
        taken = Registers.checkFlag(Registers.ZERO_FLAG);
        break; // Z
    case 2:
        taken = !Registers.checkFlag(Registers.CARRY_FLAG);
        break; // NC
    case 3:
        taken = Registers.checkFlag(Registers.CARRY_FLAG);
        break; // C
